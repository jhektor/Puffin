...
/****************************************************************/
#ifndef FINITESTRAINUOBASEDCPBASENAME_H
#define FINITESTRAINUOBASEDCPBASENAME_H
...
class FiniteStrainUObasedCPBaseName;

template <>
InputParameters validParams<FiniteStrainUObasedCPBaseName>();
 ...
 */
class FiniteStrainUObasedCPBaseName : public ComputeStressBase
{
public:
  FiniteStrainUObasedCPBaseName(const InputParameters & parameters);
...
protected:
  ...
  */
  ...
  std::vector<const CrystalPlasticitySlipRateBaseName *> _uo_slip_rates;
