...
#ifndef CRYSTALPLASTICITYSTATEVARRATECOMPONENTVOCEP_H
#define CRYSTALPLASTICITYSTATEVARRATECOMPONENTVOCEP_H
...
class CrystalPlasticityStateVarRateComponentVoceP;

template <>
InputParameters validParams<CrystalPlasticityStateVarRateComponentVoceP>();

/**
 * Phenomenological constitutive model state variable evolution rate component userobject class.
 */
class CrystalPlasticityStateVarRateComponentVoceP : public CrystalPlasticityStateVarRateComponent
{

public:
  CrystalPlasticityStateVarRateComponentVoceP(const InputParameters & parameters);
...
protected:
  ...
  /// debugging bool
  bool _check_for_errors;
};

#endif // CRYSTALPLASTICITYSTATEVARRATECOMPONENTVOCEP_H
