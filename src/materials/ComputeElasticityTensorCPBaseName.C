...
template <>
InputParameters
validParams<ComputeElasticityTensorCPBaseName>()
{
...
ComputeElasticityTensorCPBaseName::ComputeElasticityTensorCPBaseName(const InputParameters & parameters)
  : ComputeElasticityTensor(parameters),
    _read_prop_user_object(isParamValid("read_prop_user_object")
                               ...
                               : NULL),
    _Euler_angles_mat_prop(declareProperty<RealVectorValue>(_base_name + "Euler_angles")),
...
void
ComputeElasticityTensorCPBaseName::assignEulerAngles()
{
...
void
ComputeElasticityTensorCPBaseName::computeQpElasticityTensor()
{
