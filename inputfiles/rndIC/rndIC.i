...
#    [./combo]
#      type = ComboMarker
#      markers = 'errorfrac1 errorfrac2 errorfrac0'
#    [../]
#    [./errorfrac1]
...
[Materials]
  ...
  [../]
    ...
    [./nuc_eta]
      ...
      material_property_names = 'dt T kb lambda dim L h0 h2' #'h0(eta0,eta1,eta2,eta3) h2(eta0,eta1,eta2,eta3)'
      #function = '20*h0*h2'
