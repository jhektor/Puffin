...
[Preconditioning]
  [./smp]
    ...
    #Larrys suggestion
    petsc_options_iname = '-pc_asm_overlap -pc_type -sub_pc_type  -pc_factor_shift_type  -sub_pc_factor_shift_type'
    petsc_options_value = '2                  asm       lu             nonzero             nonzero'
...
[Outputs]
  file_base = 1Cu1imc2sn-e2-60-90-0-e3-45-60-0-bdf2-asm-lu-overlap2
  exodus = true
  csv = true
  print_perf_log = true
[]
