...
[Materials]
  ...
  [../]
    ...
    [./nuc_eta]
      ...
      function = 'if(h0*h2>0.001,sqrt(2*kb*T*L/(lambda^dim*dt)),0)' #expression from Shen (2007) (without h0*h2)
      #function = '100'
      outputs = exodus_out
    [../]
...
[Outputs]
  file_base = 3d-mechtest-estar0.02
  [./exodus_out]
    type = Exodus
    interval =1
  [../]
