...
[Materials]
    ...
    [./diffusion_constants]
      ...
      #prop_values = '1e-16 1e-16 1e-13' # m^2/s
    [../]
    [./model_constants]
      type = GenericConstantMaterial
    ...
    [./CHMobility]
        ...
        #material_property_names = 'h_cu h_imc h_sn D_cu D_imc D_sn A_cu A_imc A_sn length_scale energy_scale time_scale'
        function = '(length_scale^5/(energy_scale*time_scale))*(h_cu*D_cu/A_cu+h_imc*D_imc/A_imc+h_sn*D_sn/A_sn)' #nm^5/eVs
        #function = '(length_scale^5/energy_scale)*(h_cu*D_sn/A_sn+h_imc*D_sn/A_sn+h_sn*D_sn/A_sn)' #nm^5/eVs
        #material_property_names = 'D_cu D_imc D_sn A_cu A_imc A_sn length_scale energy_scale time_scale'
        #function = '(length_scale^5/(energy_scale*time_scale))*(eta_cu*D_cu/A_cu+eta_imc*D_imc/A_imc+eta_sn*D_sn/A_sn)' #nm^5/eVs
        derivative_order = 2
        outputs = exodus_out
    [../]
    ...
    [./ACMobility]
        ...
        #material_property_names = 'L_cu_imc L_imc_sn L_cu_sn h_cu h_imc h_sn'
        function = 'h_cu*h_imc*L_cu_imc+h_imc*h_sn*L_imc_sn+h_cu*h_sn*L_cu_sn'
        #material_property_names = 'L_cu_imc L_imc_sn L_cu_sn'
        #function = 'if(eta_cu>0.1,L_cu_imc,if(eta_sn>0.1,L_imc_sn,0))'
        #function = 'eta_cu*eta_imc*L_cu_imc+eta_imc*eta_sn*L_imc_sn+eta_cu*eta_sn*L_cu_sn'
        ...
        #function = 'if(eta_cu^2*eta_imc^2+eta_imc^2*eta_sn^2+eta_cu^2*eta_sn^2>1e-6,(L_cu_imc*eta_cu^2*eta_imc^2+L_imc_sn*eta_imc^2*eta_sn^2+L_cu_sn*eta_cu^2*eta_sn^2)/(eta_cu^2*eta_imc^2+eta_imc^2*eta_sn^2+eta_cu^2*eta_sn^2),1e-6)' #sets L to 0 in bulk phases
        derivative_order = 2
        outputs = exodus_out
    [../]
[]
...
[Kernels]
    ...
    [./dcdt] # Gives dc/dt
        ...
        v = c
    [../]
    [./ckernel] # Gives residual for chemical potential M\grad(mu) kansekse ska använda matDiffusion instaället, som kks_multiphase
        type = SplitCHWRes  #Ok if M is not depending on w
        mob_name = M
        variable = w
        args = 'eta_cu eta_imc eta_sn'
    [../]
