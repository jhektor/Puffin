...
[ICs]
    [./eta_cu] #Cu
        ...
        variable = eta_cu
        corners = '0. 0. 0.'
        opposite_corners = '4000. 1200-dx. 0.'
        inside = 1.
        outside = 0.
    ...
    [./eta_imc1] #Cu6Sn5
        type = MultiBoundingBoxIC
        variable = eta_imc1
        corners = '0. 1200. 0.   3000.+dx 1200. 0.'
        opposite_corners = '1000. 2600. 0   4000. 2600. 0.'
        inside = 1.
        outside = 0.
        #variable = eta_imc1
    ...
    [./eta_imc2] #Cu6Sn5
        type = MultiBoundingBoxIC
        variable = eta_imc2
        corners = '1000.+dx 1200. 0.'
        opposite_corners = '3000. 2600. 0.'
        inside = 1.
        outside = 0.
        #variable = eta_imc2
        #type = SmoothSuperellipsoidIC
    ...
    [./c] #Concentration of Sn
        ...
        inside = '0.05 0.455 0.455 0.455 0.95'
...
[Materials]
  ...
  [./model_constants]
    ...
    prop_values = '0.5 0.4e-6 5e-10 1.5 0' #J/m^2 m - ?
  [../]
  [./kappa]
    type = ParsedMaterial
  ...
  [./fch_cu] #Chemical energy Cu phase
      ...
      derivative_order = 2
  [../]
  [./fch_imc1] #Chemical energy Cu phase
      type = DerivativeParsedMaterial
      f_name = fch_imc1
      args = 'c_imc1'
      material_property_names = 'A_imc length_scale energy_scale'
      function = '(energy_scale/length_scale^3)*(0.5*A_imc*(c_imc1-0.455)^2-1e6)' #eV/nm^3
      derivative_order = 2
  [../]
  [./fch_imc2] #Chemical energy Cu phase
      type = DerivativeParsedMaterial
      f_name = fch_imc2
      args = 'c_imc2'
      material_property_names = 'A_imc length_scale energy_scale'
      function = '(energy_scale/length_scale^3)*(0.5*A_imc*(c_imc2-0.455)^2-1e6)' #eV/nm^3
      derivative_order = 2
  [../]
