...
[ICs]
    ...
    [./eta2] #Cu6Sn5
        variable = eta_imc
        type = FunctionIC
        function = 'if(x>24000&x<=25000,1,0)'
    ...
    [./c] #Concentration of Sn
        ...
        function = '0.002*if(x<=24000,1,0)+0.417*if(x>24000&x<=25000,1,0)+0.999*if(x>25000,1,0)'
...
[Materials]
    ...
    [./model_constants]
      ...
      prop_values = '0.5 0.3e-6 1.5 16.26e-6 0' #J/m^2 m - m^3/mol ?
    [../]
    [./energy_constants_A]
        type = GenericConstantMaterial
    ...
    [./ACMobility]
        ...
        #function = '0.5*(L_imc_sn+L_cu_imc)'#'h_cu*h_imc*L_cu_imc+h_imc*h_sn*L_imc_sn+h_cu*h_sn*L_cu_sn'
...
[Outputs]
  file_base = test_Lij #line_room_temp
  [./exodus_out]
    type = Exodus
    interval = 1 #25
  [../]
