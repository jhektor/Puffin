...
[ICs]
    ...
    [./c] #Concentration of Sn
        variable = c
        type = FunctionIC
        #function = '0.0208*if(x<=48500,1,0)+0.4355*if(x>48500&x<=51500,1,0)+0.9996*if(x>51500,1,0)'
        function = '0.0109*if(x<=46000,1,0)+0.4355*if(x>46000&x<=54000,1,0)+0.95*if(x>54000,1,0)'
...
[Materials]
    ...
    [../]
    [./energy_constants_A] #From Li2009 (should make new fit)
        type = GenericConstantMaterial
        prop_names = 'A_cu A_imc A_sn'
        prop_values = '4.0359e5/Vm 4e6/Vm 7.3613e5/Vm' #J/m^3
    [../]
    [./energy_constants_B]
        type = GenericConstantMaterial
        prop_names = 'B_cu B_imc B_sn'
        prop_values = '-4.1474e4/Vm 1.9832e3/Vm 5.0136e3/Vm' #J/m^3
    [../]
    [./energy_constants_C]
        type = GenericConstantMaterial
        prop_names = 'Ce_cu Ce_imc Ce_sn'
        prop_values = '-1.4680e4/Vm -2.4536e4/Vm -2.1730e4/Vm' #J/m^3
    [../]
    [./energy_constants_c_eq]
        type = GenericConstantMaterial
        prop_names = 'c_cu_imc c_imc_cu c_imc_sn c_sn_imc c_cu_sn c_sn_cu'
        prop_values = '0.0584 0.4294 0.4363 0.9953 0.0997 0.9809' # -
    [../]
    [./energy_constants_chat]
        type = GenericConstantMaterial
        prop_names = 'chat_cu chat_imc chat_sn'
        prop_values = '0.0109 0.4355 0.9953' # -
    [../]
    [./diffusion_constants]
      type = GenericConstantMaterial
      prop_names = 'D_cu D_imc D_sn'
      prop_values = '1.331-26 5.7841e-16 6.1120e-15' # m^2/s
    [../]
    [./kappa]
      type = ParsedMaterial
    ...
    [./fch_imc] #Chemical energy Cu phase
        ...
        function = '(energy_scale/length_scale^3)*(0.5*A_imc*(c_imc-chat_imc)^2+B_imc*(c_imc-chat_imc)+Ce_imc)' #eV/nm^3
        derivative_order = 2
    [../]
    ...
    [./ACMobility]
        ...
        function = 'L_imc_sn'#'h_cu*h_imc*L_cu_imc+h_imc*h_sn*L_imc_sn+h_cu*h_sn*L_cu_sn'
...
[Outputs]
  file_base = test140 #line_room_temp
  [./exodus_out]
    type = Exodus
    interval = 1 #25
  [../]
