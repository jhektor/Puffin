...
[GlobalParams]
  ...
  #enable_jit = true
  displacements = 'disp_x disp_y disp_z'
  #block = 'front_TET4 bottom_TET4 top_TET4'
[]
[Variables]
  [./disp_x]
    #scaling = 1e-1
...
[ICs]
  ...
  [./eta0] #Cu grain
    type = FunctionIC
    variable = eta0
    function = 'if(y<=-440,1,if(y>=440,1,0))'
  [../]
  [./eta3]
    type = UnitySubVarIC
    variable = eta3
  ...
  [./w]
    type = FunctionIC
    variable = w
    function = 'if(y<=-440,-16.4486,if(y>=440,-16.4486,-0.74034))'
  [../]
[]
...
[BCs]
  ...
  [./symmz]
    type = PresetBC
    variable = disp_z
    boundary = 'bottom top front'# front back'
    value = 0
  [../]
[]
[UserObjects]
