...
# []
[Mesh]
  file = 1Cu1imc2sn-e2-60-90-0-e3-45-60-0-bdf2-asm-110calib.e
...
[Variables]
  ...
  []
  [eta1]
    # initial_condition = 0 #removed when loading existing
    # scaling = 1e1
...
[Materials]
  ...
  []
  [fch_sn]
    # Chemical energy Sn central grain
    type = DerivativeParsedMaterial
    f_name = fch2
    args = 'c2'
  ...
  []
  [global_stress]
    # homogeniserar bara Cauchy stress
...
[Outputs]
  file_base = 1Cu1imc2sn-e2-60-90-0-e3-45-60-0-bdf2-asm-lowT-test
  exodus = true
  csv = true
[]
