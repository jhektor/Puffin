...
[Materials]
  ...
  [./pre]
    ...
    # args = 'eta0 eta1 eta2 eta3'
    args = 'h1h2 h1h3 h1h0' # ändrad
    # material_property_names = 'h1h0 h1h2 h1h3'
    function = '0.02*(h1h2+h1h3)-0.02*h1h0' # ändrad
    f_name = pre
    outputs = exodus
  [../]
  [./fe1]
  ...
  [./energy_A_cu]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool A_cu_220 A_cu_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  A_cu_220+(A_cu_25-A_cu_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),A_cu_25),
                  A_cu_220)'
      f_name = A_cu
  [../]
  [./energy_A_eps] #eps phase is redundant
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool A_eps_220 A_eps_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  A_eps_220+(A_eps_25-A_eps_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),A_eps_25),
                  A_eps_220)'
      f_name = A_eps
  [../]
  [./energy_A_eta]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool A_eta_220 A_eta_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  A_eta_220+(A_eta_25-A_eta_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),A_eta_25),
                  A_eta_220)'
      f_name = A_eta
  [../]
  [./energy_A_sn]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool A_sn_220 A_sn_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  A_sn_220+(A_sn_25-A_sn_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),A_sn_25),
                  A_sn_220)'
      f_name = A_sn
  [../]
  [./energy_B_cu]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool B_cu_220 B_cu_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  B_cu_220+(B_cu_25-B_cu_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),B_cu_25),
                  B_cu_220)'
      f_name = B_cu
  [../]
  [./energy_B_eps] #eps phase is redundant
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool B_eps_220 B_eps_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  B_eps_220+(B_eps_25-B_eps_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),B_eps_25),
                  B_eps_220)'
      f_name = B_eps
  [../]
  [./energy_B_eta]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool B_eta_220 B_eta_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  B_eta_220+(B_eta_25-B_eta_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),B_eta_25),
                  B_eta_220)'
      f_name = B_eta
  [../]
  [./energy_B_sn]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool B_sn_220 B_sn_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  B_sn_220+(B_sn_25-B_sn_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),B_sn_25),
                  B_sn_220)'
      f_name = B_sn
  [../]
  [./energy_C_cu]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool C_cu_220 C_cu_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  C_cu_220+(C_cu_25-C_cu_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),C_cu_25),
                  C_cu_220)'
      f_name = C_cu
  [../]
  [./energy_C_eps] #eps phase is redundant
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool C_eps_220 C_eps_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  C_eps_220+(C_eps_25-C_eps_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),C_eps_25),
                  C_eps_220)'
      f_name = C_eps
  [../]
  [./energy_C_eta]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool C_eta_220 C_eta_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  C_eta_220+(C_eta_25-C_eta_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),C_eta_25),
                  C_eta_220)'
      f_name = C_eta
  [../]
  [./energy_C_sn]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool C_sn_220 C_sn_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  C_sn_220+(C_sn_25-C_sn_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),C_sn_25),
                  C_sn_220)'
      f_name = C_sn
  [../]
  ...
  [./energy_chat_cu]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool chat_cu_220 chat_cu_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  chat_cu_220+(chat_cu_25-chat_cu_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),chat_cu_25),
                  chat_cu_220)'
      f_name = chat_cu
  [../]
  [./energy_chat_eps]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool chat_eps_220 chat_eps_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  chat_eps_220+(chat_eps_25-chat_eps_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),chat_eps_25),
                  chat_eps_220)'
      f_name = chat_eps
  [../]
  [./energy_chat_eta]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool chat_eta_220 chat_eta_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  chat_eta_220+(chat_eta_25-chat_eta_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),chat_eta_25),
                  chat_eta_220)'
      f_name = chat_eta
  [../]
  [./energy_chat_sn]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool chat_sn_220 chat_sn_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  chat_sn_220+(chat_sn_25-chat_sn_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),chat_sn_25),
                  chat_sn_220)'
      f_name = chat_sn
  [../]
  [./bulk_diff_D_cu]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool D_cu_220 D_cu_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  D_cu_220+(D_cu_25-D_cu_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),D_cu_25),
                  D_cu_220)'
      f_name = D_cu
  [../]
  [./bulk_diff_D_eps]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool D_eps_220 D_eps_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  D_eps_220+(D_eps_25-D_eps_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),D_eps_25),
                  D_eps_220)'
      f_name = D_eps
  [../]
  [./bulk_diff_D_eta]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool D_eta_220 D_eta_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  D_eta_220+(D_eta_25-D_eta_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),D_eta_25),
                  D_eta_220)'
      f_name = D_eta
  [../]
  [./bulk_diff_D_sn]
      type =  ParsedMaterial
      material_property_names = 'time t_start_cool t_end_cool D_sn_220 D_sn_25'
      function = 'if(time>t_start_cool,
                  if(time<t_end_cool,
                  D_sn_220+(D_sn_25-D_sn_220)*(time-t_start_cool/(t_end_cool-t_start_cool)),D_sn_25),
                  D_sn_220)'
      f_name = D_sn
  [../]
  [./D_gb]
...
[AuxKernels]
  [./h1h0] # ändrad
    ...
    variable = h1h0
    args = 'h1 h0 h1h0'
    function = 'if(h1*h0>h1h0,h1*h0,h1h0)'
  ...
  [./h1h2] # ändrad
    ...
    variable = h1h2
    args = 'h1 h2 h1h2'
    function = 'if(h1*h2>h1h2,h1*h2,h1h2)'
    execute_on = 'LINEAR TIMESTEP_END'
  [../]
  [./h1h3] # ändrad
    type = ParsedAux
    variable = h1h3
    args = 'h1 h3 h1h3'
    function = 'if(h1*h3>h1h3,h1*h3,h1h3)'
    execute_on = 'LINEAR TIMESTEP_END'
  [../]
