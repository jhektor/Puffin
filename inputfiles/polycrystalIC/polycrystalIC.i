...
[BCs]
  [./Periodic]
    ...
    [./xy]
      ...
      variable = 'eta0 eta1 eta2 eta3 c w c0 c1 c2 c3'
    [../]
  [../]
...
[Materials]
  ...
  [./nuc]
    ...
    f_name = nuc
    material_property_names = 'time dt T kb lambda dim L h0(eta0,eta1,eta2,eta3) h2(eta0,eta1,eta2,eta3) h1(eta0,eta1,eta2,eta3)'
...
[Outputs]
  file_base = 1Cu1imc2sn-polycrystalIC-100x100x10-periodicxyz
  exodus = true
  csv = true
  print_perf_log = true
[]
