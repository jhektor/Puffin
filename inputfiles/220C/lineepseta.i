...
[Materials]
  ...
  [./diffusion_constants]
    ...
    #prop_values = '2.8311e-23 2.7650e-16 5.9702e-15 4.0866e-14' # m^2/s #low Deps
    #prop_values = '2.8311e-23 2e-16 1e-14 4.0866e-14' # m^2/s #low Deps high Deta high Dsn
    #prop_values = '1.6e-20 8e-20 4e-19 4.0866e-14' # m^2/s #park ratios
    #prop_values = '2e-20 2e-16 8e-15 2e-14' # m^2/s #
    #prop_values = '5e-24 1.5e-15 4e-15 3e-14' # m^2/s # arrhenius
    #prop_values = '5e-24 1.5e-16 4e-15 3e-14' # m^2/s # too slow both phases growing
    #prop_values = '5e-24 3e-16 8e-15 3e-14' # m^2/s #too slow both phases growing D7
    #prop_values = '1e-23 6e-16 1.5e-14 3e-14' # m^2/s #ok, Cu6Sn5 a bit slow, both phases growing D8
    #prop_values = '1e-23 6e-16 3e-14 3e-14' # m^2/s #good but crashes D9
    #prop_values = '1e-20 1e-16 1e-14 3e-14' # m^2/s #D10 Cu3Sn shrinks
    #prop_values = '1e-20 6e-16 1.5e-14 3e-14' # m^2/s #D11 Cu6Sn5 a bit slow
    #prop_values = '1e-20 6e-16 1.5e-14 1e-13' # m^2/s #D12 best slightly slow
    #prop_values = '1e-20 6e-16 3e-14 1e-13' # m^2/s #D13 Cu3Sn shrinks
    #prop_values = '1e-20 6e-16 2e-14 1e-13' # m^2/s #D14
...
[Outputs]
  file_base = line220C-lennartfig32-34-Aeps2e6Aeta2e6-D14
  [./exodus_out]
    type = Exodus
    interval = 1
  [../]
