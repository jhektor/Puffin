...
%% Use this for fitting without Cu3Sn
...
%     G0alphacu=-7770.458+130.485235*T-24.112392*T*log(T)-0.00265684*T^2+1.29223E-7*T^3+52478*T^-1;
    G0alphacu=-7770.458+130.485235*T-24.112392*T*log(T)-2.65684e-3*T^2+1.29223E-7*T^3+52478*T^-1; %Du2009
else
...
if T<505.078
        G0alphasn=-345.135+56.983315*T-15.961*T*log(T)-0.0188702*T^2+3.121167e-6*T^3-61960*T^-1; %Du2009 fcc
...
[chat_cu,ceta_cu]=vpasolve([e1,e2],[c1,c2],init_guess);

t0=subs(Gscu,cs,chat_cu)-subs(mucus,cs,chat_cu)*chat_cu+subs(mucus,cs,chat_cu)*cs;
