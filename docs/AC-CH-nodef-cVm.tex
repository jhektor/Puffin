...
\begin{equation}
\begin{aligned}
  \partdiff{\eta_i}{t}&=-L(\vbf{\eta})\vardiff{F}{\eta_i}+\xi(\vbf{x},t)=-L\left(\partdiff{F}{\eta_i}-\gradient\cdot\partdiff{F}{\gradient\eta_i}\right)\\
  &=-L\left(\partdiff{f^{ch}}{\eta_i}+\partdiff{f^{int}}{\eta_i}+\partdiff{f^d}{\eta_i}-\gradient\cdot\partdiff{f^{int}}{\gradient\eta_i}-\gradient\cdot\partdiff{f^d}{\gradient\eta_i}\right).
\end{aligned}
\label{eq:AC1}
\end{equation}
...
\begin{equation}
\begin{aligned}
  \vbf{R}_{\eta_i}&=\vint{\partdiff{\eta_i}{t}}{\psi}+\vint{L\left(\partdiff{f^{ch}}{\eta_i}+\partdiff{f^{int}}{\eta_i}+\partdiff{f^d}{\eta_i}\right)}{\psi}-\vint{L\gradient\cdot\alpha\gradient\eta_i}{\psi} \\
...
\begin{aligned}
  ...
  &+\vint{L\partdiff{f^d}{\eta_i}}{\psi}+\vint{\alpha\gradient\eta_i}{\gradient L\psi} -\sint{(\alpha\gradient\eta_i)\cdot\vbf{n}}{L\psi}
 \end{aligned}
\end{equation}
