...
\begin{equation}
  \partdiff{f_{ch}}{\eta_i}=\sum_j\partdiff{h_j}{\eta_i}\left(f_j-\mu_jx_j\right)
\end{equation}
...
\begin{aligned}
  ...
  &+\vint{L\partdiff{f_d}{\eta_i}}{\psi}+\vint{\alpha\gradient\eta_i}{\gradient L\psi} -\sint{(\alpha\gradient\eta_i)\cdot\vbf{n}}{L\psi}
 \end{aligned}
\end{equation}
